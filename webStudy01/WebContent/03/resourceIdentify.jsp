...
2. 클래스 패스(classpath) 자원 : classpath 기준 경로를 통한 식별
3. 웹리소스 식별
	...
	URL
	shceme://domain:port/context/depth1/depth2....../resource_name
	절대경로 : http://localhost:80/webStudy01/images/Koala.jpg
		client-side : /webStudy01/images/Tulips.jpg
	...
	<img src="/webStudy01/images/Tulips.jpg"/>
	<img src="http://localhost:80/webStudy01/images/Tulips.jpg" />
